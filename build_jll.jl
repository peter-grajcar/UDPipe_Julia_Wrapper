...
BinaryBuilder.rebuild_jll_package(json_obj, download_dir="products", upload_prefix="https://github.com/peter-grajcar/UDPipe_Julia_Wrapper/releases/download/v$version")
